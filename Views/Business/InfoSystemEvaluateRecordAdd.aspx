<%@ Page Language="C#" MasterPageFile="~/InnerAjaxPage.Master" AutoEventWireup="true" CodeBehind="InfoSystemEvaluateRecordAdd.aspx.cs" Inherits="ISIWP.Platform.WebClient.Views.Business.InfoSystemEvaluateRecordAdd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHead" runat="server">
    ...
    <script src="Resources/Scripts/Business/Views/InfoSystemEvaluateRecordAdd.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(function () {
            var ajaxContainerSelector = "#<%= this.MasterAjaxContainerID %>";
            window.business.InfoSystemEvaluateRecordAdd_aspx.initPage(ajaxContainerSelector);
        });
    </script>
</asp:Content>
