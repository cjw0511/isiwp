<%@ Page Title="" Language="C#" MasterPageFile="~/InnerAjaxPage.Master" AutoEventWireup="true" CodeBehind="ContactUpdate.aspx.cs" Inherits="ISIWP.Platform.WebClient.Views.Business.ContactUpdate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHead" runat="server">
    ...
    <script src="Resources/Scripts/Business/Views/ContactUpdate.js" type="text/javascript"></script>
    <script language="javascript" type="text/javascript">
        $(function () {
            var ajaxContainerSelector = "#<%= this.MasterAjaxContainerID %>";
            var key = '<%= this.Request["key"] %>';
            window.business.ContactUpdate_aspx.initPage(ajaxContainerSelector, key);
        });
    </script>
</asp:Content>
            ...
            <table class="tablecss" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td class="table_td_right" colspan="4">
                        <textarea id="txtRemark" name="Remark" style="overflow: auto; height: 60px; width: 620px;" maxlength="500"></textarea>
                    </td>
                </tr>
            </table>
        </fieldset>
