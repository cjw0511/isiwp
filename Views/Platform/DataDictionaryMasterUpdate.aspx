<%@ Page Title="" Language="C#" MasterPageFile="~/InnerAjaxPage.Master" AutoEventWireup="true" CodeBehind="DataDictionaryMasterUpdate.aspx.cs" Inherits="ISIWP.Platform.WebClient.Views.Platform.DataDictionaryMasterUpdate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHead" runat="server">
    ...
    <script src="Resources/Scripts/Platform/Views/DataDictionaryMasterUpdate.js" type="text/javascript"></script>
    <script language="javascript" type="text/javascript">
        $(function () {
            var ajaxContainerSelector = "#<%= this.MasterAjaxContainerID %>";
            var key = '<%= this.Request["key"] %>';
            window.platform.DataDictionaryMasterUpdate_aspx.initPage(ajaxContainerSelector, key);
        });
    </script>
</asp:Content>
...
<div class="div_center">
    <fieldset class="datebox-button" style="padding: 8px;height: auto;text-align: left;">
        ...
        <tr><td class="tleft">Key：</td><td class="table_td_right"><input type="text" readonly="readonly" id="txtKey" name="Key" style="width:400px" /></td></tr>
