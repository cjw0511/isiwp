<%@ Page Title="" Language="C#" MasterPageFile="~/InnerAjaxPage.Master" AutoEventWireup="true" CodeBehind="EmployeeAdd.aspx.cs" Inherits="ISIWP.Platform.WebClient.Views.Platform.EmployeeAdd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHead" runat="server">
    ...
    <script src="Resources/Scripts/Platform/Views/EmployeeAdd.js" type="text/javascript"></script>
    <script language="javascript" type="text/javascript">
        $(function () {
            var ajaxContainerSelector = "#<%= this.MasterAjaxContainerID %>";
            window.platform.EmployeeAdd_aspx.initPage(ajaxContainerSelector);
        });
    </script>
</asp:Content>
                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding-top: 4px;">
                                        <input id="txtUser" /><input type="hidden" id="UserKey" name="UserKey" />&nbsp;
                                    </td>
                                    <td>
