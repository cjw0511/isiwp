<%@ Page Title="" Language="C#" MasterPageFile="~/InnerAjaxPageForm.Master" AutoEventWireup="true" CodeBehind="DepartmentAdd.aspx.cs" Inherits="ISIWP.Platform.WebClient.Views.Platform.DepartmentAdd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHead" runat="server">
    ...
    <script src="Resources/Scripts/Platform/Views/DepartmentAdd.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(function () {
            var ajaxContainerSelector = "#<%= this.MasterAjaxContainerID %>";
            var key = '<%= this.Request["key"] %>';
            window.platform.DepartmentAdd_aspx.initPage(ajaxContainerSelector, key);
        });
    </script>
</asp:Content>
