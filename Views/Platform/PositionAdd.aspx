<%@ Page Title="" Language="C#" MasterPageFile="~/InnerAjaxPageForm.Master" AutoEventWireup="true" CodeBehind="PositionAdd.aspx.cs" Inherits="ISIWP.Platform.WebClient.Views.Platform.PositionAdd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHead" runat="server">
    <script src="Resources/Scripts/Platform/Libs/positionlib.js" type="text/javascript"></script>
    <script src="Resources/Scripts/Platform/Views/PositionAdd.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(function () {
            var ajaxContainerSelector = "#<%= this.MasterAjaxContainerID %>";
            window.platform.PositionAdd_aspx.initPage(ajaxContainerSelector);
        });
    </script>
</asp:Content>
