<%@ Page Title="" Language="C#" MasterPageFile="~/InnerAjaxPageForm.Master" AutoEventWireup="true" CodeBehind="UserGroupAdd.aspx.cs" Inherits="ISIWP.Platform.WebClient.Views.Platform.UserGroupAdd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHead" runat="server">
    <script src="Resources/Scripts/Platform/Libs/userGrouplib.js" type="text/javascript"></script>
    <script src="Resources/Scripts/Platform/Views/UserGroupAdd.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(function () {
            var ajaxContainerSelector = "#<%= this.MasterAjaxContainerID %>";
            window.platform.UserGroupAdd_aspx.initPage(ajaxContainerSelector);
        });
    </script>
</asp:Content>
