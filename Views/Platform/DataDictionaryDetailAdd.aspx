<%@ Page Title="" Language="C#" MasterPageFile="~/InnerAjaxPage.Master" AutoEventWireup="true" CodeBehind="DataDictionaryDetailAdd.aspx.cs" Inherits="ISIWP.Platform.WebClient.Views.Platform.DataDictionaryDetailAdd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHead" runat="server">
    <script src="Resources/Scripts/Platform/Libs/dataDictionarylib.js" type="text/javascript"></script>
    <script src="Resources/Scripts/Platform/Views/DataDictionaryDetailAdd.js" type="text/javascript"></script>
    <script language="javascript" type="text/javascript">
        $(function () {
            var ajaxContainerSelector = "#<%= this.MasterAjaxContainerID %>";
            window.platform.DataDictionaryDetailAdd_aspx.initPage(ajaxContainerSelector);
        });
    </script>
</asp:Content>
...
<div class="div_center">
    <fieldset class="datebox-button" style="padding: 8px;height: auto;text-align: left;">
        ...
        <tr><td class="table_td_left">编号：</td><td class="table_td_right"><input type="text" id="txtCode" name="Code" maxlength="50" /></td>
            <td class="table_td_left">值：</td><td class="table_td_right"><input type="text" id="txtValue" name="Value" maxlength="100" /></td></tr>
        ...
        <tr><td class="table_td_left">附加值3：</td><td class="table_td_right"><input type="text" id="txtValue3" name="Value3" maxlength="100" /></td>
                <td class="table_td_left">附加值4：</td><td class="table_td_right"><input type="text" id="txtValue4" name="Value4" maxlength="100" /></td></tr>
        <tr><td class="table_td_left">值附加5：</td><td class="table_td_right"><input type="text" id="txtValue5" name="Value5" maxlength="100" /></td>
                <td class="table_td_left">附加值6：</td><td class="table_td_right"><input type="text" id="txtValue6" name="Value6" maxlength="100" /></td></tr>
