<%@ Page Title="" Language="C#" MasterPageFile="~/InnerAjaxPageForm.Master" AutoEventWireup="true" CodeBehind="PartitionAdd.aspx.cs" Inherits="ISIWP.Platform.WebClient.Views.Platform.PartitionAdd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHead" runat="server">
    <script src="Resources/Scripts/Platform/Libs/partitionlib.js" type="text/javascript"></script>
    <script src="Resources/Scripts/Platform/Views/PartitionAdd.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(function () {
            var ajaxContainerSelector = "#<%= this.MasterAjaxContainerID %>";
            window.platform.PartitionAdd_aspx.initPage(ajaxContainerSelector);
        });
    </script>
</asp:Content>
