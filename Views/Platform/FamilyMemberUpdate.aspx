<%@ Page Title="" Language="C#" MasterPageFile="~/InnerAjaxPage.Master" AutoEventWireup="true" CodeBehind="FamilyMemberUpdate.aspx.cs" Inherits="ISIWP.Platform.WebClient.Views.Platform.FamilyMemberUpdate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHead" runat="server">
    <script src="Resources/Scripts/Platform/Libs/employeelib.js" type="text/javascript"></script>
    <script src="Resources/Scripts/Platform/Views/FamilyMemberUpdate.js" type="text/javascript"></script>
    <script language="javascript" type="text/javascript">
        $(function () {
            var ajaxContainerSelector = "#<%= this.MasterAjaxContainerID %>";
            var id = '<%= this.Request["id"] %>';
            window.platform.FamilyMemberUpdate_aspx.initPage(ajaxContainerSelector, id);
        });
    </script>
</asp:Content>
...
<div class="div_center">
    <fieldset class="datebox-button" style="padding: 8px;height: auto;text-align: left;">
        ...
        <tr><td class="table_td_left" style="vertical-align:baseline;padding-top:7px;">简介：</td><td colspan="3" style="padding-top:5px;">
            <textarea id="txtSummary" name="Summary" rows="4" maxlength="50" ></textarea></td></tr>
        </table>
    </fieldset>
</div>
</asp:Content>