<%@ Page Title="" Language="C#" MasterPageFile="~/InnerAjaxPage.Master" AutoEventWireup="true" CodeBehind="SubRectificationMainAdd.aspx.cs" Inherits="ISIWP.Platform.WebClient.Views.Project.SubRectificationMainAdd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHead" runat="server">
<script src="Resources/Scripts/Project/Views/SubRectificationMainAdd.js" type="text/javascript"></script>
<script src="Resources/Scripts/Project/Common/projcomlib.js" type="text/javascript"></script>
<script language="javascript" type="text/javascript">
    $(function () {
        var ajaxContainerSelector = "#<%= this.MasterAjaxContainerID %>";
        window.project.SubRectificationMainAdd_aspx.initPage(ajaxContainerSelector);
    });
</script>
</asp:Content>
...
<div class="div_center">
    ...
    <table class="tablecss" cellpadding="0" cellspacing="0">
        <tr>
            <td class="table_td_left">模板标题<span class="required">*</span>：</td><td class="table_td_right"><input type="text" id="txtTitle3" name="Title" maxlength="32" />(限制：32字)</td>
        ...
        <tr>
            ...
            <td class="table_td_left">排序号：</td><td class="table_td_right"><input type="text" id="txtSort3" name="Sort" maxlength="5" value="0" /></td>
        </tr>
    </table>
    </fieldset>
</div>
