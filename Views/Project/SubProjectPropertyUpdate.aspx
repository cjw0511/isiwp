<%@ Page Title="" Language="C#" MasterPageFile="~/InnerAjaxPage.Master" AutoEventWireup="true" CodeBehind="SubProjectPropertyUpdate.aspx.cs" Inherits="ISIWP.Platform.WebClient.Views.Project.SubProjectPropertyUpdate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHead" runat="server">
    <script src="Resources/Scripts/Project/Views/SubProjectPropertyUpdate.js" type="text/javascript"></script>
    <script language="javascript" type="text/javascript">
        $(function () {
            var ajaxContainerSelector = "#<%= this.MasterAjaxContainerID %>";
            var subkey = '<%= this.Request["key"] %>';
            var syskey = '<%= this.Request["syskey"] %>';
            var porkey = '<%= this.Request["porkey"] %>';
            window.project.SubProjectPropertyUpdate_aspx.initPage(ajaxContainerSelector, porkey, subkey, syskey);
        });
    </script>
</asp:Content>
