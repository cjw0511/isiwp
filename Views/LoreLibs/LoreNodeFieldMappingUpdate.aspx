<%@ Page Title="" Language="C#" MasterPageFile="~/InnerAjaxPage.Master" AutoEventWireup="true" CodeBehind="LoreNodeFieldMappingUpdate.aspx.cs" Inherits="ISIWP.Platform.WebClient.Views.LoreLibs.LoreNodeFieldMappingUpdate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHead" runat="server">
    <script src="Resources/Scripts/LoreLibs/Libs/lorefieldlib.js" type="text/javascript"></script>
    <script src="Resources/Scripts/LoreLibs/Views/LoreNodeFieldMappingUpdate.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(function () {
            var ajaxContainerSelector = "#<%= this.MasterAjaxContainerID %>";
            var key = '<%= this.Request["key"] %>';
            window.lorelibs.LoreNodeFieldMappingUpdate_aspx.initPage(ajaxContainerSelector, key);
        });
    </script>
</asp:Content>
