<%@ Page Title="" Language="C#" MasterPageFile="~/InnerAjaxPage.Master" AutoEventWireup="true" CodeBehind="LoreFieldUpdate.aspx.cs" Inherits="ISIWP.Platform.WebClient.Views.LoreLibs.LoreFieldUpdate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHead" runat="server">
    <script src="Resources/Scripts/LoreLibs/Views/LoreFieldUpdate.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(function () {
            var ajaxContainerSelector = "#<%= this.MasterAjaxContainerID %>";
            var key = '<%= this.Request["key"] %>';
            window.lorelibs.LoreFieldUpdate_aspx.initPage(ajaxContainerSelector, key);
        });
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="server">
    <div class="div_center">
        ...
        <table class="tablecss" cellpadding="0" cellspacing="0">
            ...
            <tr><td class="table_td_left">数据类型：</td><td class="table_td_right"><select id="selDataType" name="DataType" ></select></td>
            ...
            <tr><td class="table_td_left">控件行数：</td><td class="table_td_right"><input type="text" id="txtRows" name="Rows" class="easyui-numberspinner" data-options="min:1,max:10,required:true" /></td>
