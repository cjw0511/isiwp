<%@ Page Title="" Language="C#" MasterPageFile="~/InnerAjaxPage.Master" AutoEventWireup="true" CodeBehind="ItemAdd.aspx.cs" Inherits="ISIWP.Platform.WebClient.Views.LoreLibs.ItemAdd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHead" runat="server">
<script src="Resources/Scripts/LoreLibs/Views/ItemAdd.js" type="text/javascript"></script>
<script type="text/javascript">
    $(function () {
        var ajaxContainerSelector = "#<%= this.MasterAjaxContainerID %>";
        window.lorelibs.ItemAdd_aspx.initPage(ajaxContainerSelector);
    });
</script>
</asp:Content>
