<%@ Page Title="" Language="C#" MasterPageFile="~/InnerAjaxPage.Master" AutoEventWireup="true" CodeBehind="UnitAdd.aspx.cs" Inherits="ISIWP.Platform.WebClient.Views.LoreLibs.UnitAdd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHead" runat="server">
<script src="Resources/Scripts/LoreLibs/Views/UnitAdd.js" type="text/javascript"></script>
<script type="text/javascript">
    $(function () {
        var ajaxContainerSelector = "#<%= this.MasterAjaxContainerID %>";
        window.lorelibs.UnitAdd_aspx.initPage(ajaxContainerSelector);
    });
</script>
</asp:Content>
