<%@ Page Title="" Language="C#" MasterPageFile="~/InnerAjaxPageForm.Master" AutoEventWireup="true" CodeBehind="LoreTypeUpdate.aspx.cs" Inherits="ISIWP.Platform.WebClient.Views.LoreLibs.LoreTypeUpdate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHead" runat="server">
    <script src="Resources/Scripts/LoreLibs/Libs/loretypelib.js" type="text/javascript"></script>
    <script src="Resources/Scripts/LoreLibs/Views/LoreTypeUpdate.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(function () {
            var ajaxContainerSelector = "#<%= this.MasterAjaxContainerID %>";
            var key = '<%= this.Request["key"] %>';
            window.lorelibs.LoreTypeUpdate_aspx.initPage(ajaxContainerSelector, key);
        });
    </script>
</asp:Content>
        ...
        <fieldset class="datebox-button" style="padding: 8px;height: auto;text-align: left;">
            ...
            <table class="tablecss" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td class="table_td_right"><select id="txtType" class="easyui-combobox" data-options="disabled:true" ><option value="1" selected="selected">目录节点</option><option value="2">知识节点</option></select></td>
