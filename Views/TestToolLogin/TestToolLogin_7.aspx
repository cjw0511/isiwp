<%@ Page Title="" Language="C#" MasterPageFile="~/InnerAjaxPage.Master" AutoEventWireup="true" CodeBehind="TestToolLogin_7.aspx.cs" Inherits="ISIWP.Platform.WebClient.Views.TestToolLogin.TestToolLogin_7" %>
...
<div style="height:100%;width:100%;position: relative;background:url('Resources/Images/Platform/blackground/login.png') no-repeat center;">
    <div style="position:absolute;left:50%;top:50%;margin-left:-290px; margin-top:-165px ">
        <div style="background:url('Resources/Images/Platform/blackground/triangle.png') no-repeat;color:#fff;font-size:20px;font-weight:bolder;padding-left:20px;">明鉴数据库弱点扫描器（DAS-DBScan 2.0）</div>
        <div style="height:210px;width:523px;padding:25px 20px 30px 20px;">
            ...
            <div style="float:left">
                <div style="height:185px;width:250px;border:1px solid #A5B8C9;padding:5px;background-color:#fff;">
                    <table>
                    <tr>
                        <td style="color:#4989A4;font-weight:bolder;font-size:13px;" colspan="2">
                            测试对象选择
                        </td>
                    </tr>
                    <tr>
