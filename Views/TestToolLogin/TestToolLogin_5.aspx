<%@ Page Title="" Language="C#" MasterPageFile="~/InnerAjaxPage.Master" AutoEventWireup="true" CodeBehind="TestToolLogin_5.aspx.cs" Inherits="ISIWP.Platform.WebClient.Views.TestToolLogin.TestToolLogin_5" %>
...
<div style="height:100%;width:100%;position: relative;background:url('Resources/Images/Platform/blackground/login.png') no-repeat center;">
    <div style="position:absolute;left:50%;top:50%;margin-left:-290px; margin-top:-165px ">
        <div style="background:url('Resources/Images/Platform/blackground/triangle.png') no-repeat;color:#fff;font-size:20px;font-weight:bolder;padding-left:20px;">明鉴WEB应用弱点扫描器（MatriXay 5.0）</div>
