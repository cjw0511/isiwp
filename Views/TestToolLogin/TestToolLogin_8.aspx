<%@ Page Title="" Language="C#" MasterPageFile="~/InnerAjaxPage.Master" AutoEventWireup="true" CodeBehind="TestToolLogin_8.aspx.cs" Inherits="ISIWP.Platform.WebClient.Views.TestToolLogin.TestToolLogin_8" %>
...
<div style="height:100%;width:100%;position: relative;background:url('Resources/Images/Platform/blackground/login.png') no-repeat center;">
    <div style="position:absolute;left:50%;top:50%;margin-left:-290px; margin-top:-165px ">
        <div style="background:url('Resources/Images/Platform/blackground/triangle.png') no-repeat;color:#fff;font-size:20px;font-weight:bolder;padding-left:20px;">安华金和数据库漏洞扫描系统V3.0</div>
