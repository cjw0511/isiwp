...
(function ($, undefined) {
    ...
    var css =
        ".window-body-hidden { background-color: #95b8e7; filter: alpha(opacity=80); opacity: 0.8; }" +
        ".window-proxy { background-color: #0e2d5f; filter: alpha(opacity=80); opacity: 0.8; }";
    $.util.addCss(css);
